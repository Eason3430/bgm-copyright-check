...
WIN_SHA256 = "00dcc56d911f2dea84737aa9dc8e2d118c9eb7a037d815d1ed001d8593e8fbee"
...
def main():
    ...
    if plat.startswith("win"):
        ...
        try:
            ...
            print("下载失败：", e)
            sys.exit(1)
        print("下载完成 (%d 字节)，校验 SHA256 ..." % n)
        actual = _sha256(zip_path)
        if actual.lower() != WIN_SHA256.lower():
            print("⚠️ SHA256 不匹配！可能下载被篡改或版本变更。")
            print("  期望:", WIN_SHA256)
            print("  实际:", actual)
            sys.exit(1)
